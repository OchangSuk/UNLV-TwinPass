// Classifier module
let classifierInitialized = Boolean(Module.calledRun);
...
class EdgeImpulseClassifier {
    ...
    init() {
        ...
        const initializeClassifier = (resolve, reject) => {
            classifierInitialized = true;
            let ret = Module.init();
        ...
        if (classifierInitialized === true || Module.calledRun) {
            return new Promise(initializeClassifier);
        }

        return new Promise((resolve, reject) => {
            Module.onRuntimeInitialized = () => {
                initializeClassifier(resolve, reject);
            };
        });
    }
...
// Expose the generated classifier to the TwinPass client application.
